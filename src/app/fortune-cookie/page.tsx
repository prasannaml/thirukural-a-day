...
export default function FortuneCookiePage() {
  ...
  return (
    <main className="mx-auto max-w-3xl px-4 py-10">
      ...
      <h1 className="text-3xl font-bold">🥠 Kural Fortune Cookie</h1>

      <p className="mt-4 text-gray-600 dark:text-gray-400">
        Click the button below to open your fortune cookie and discover your daily kural. You'll get the same fortune each day until tomorrow arrives!
      </p>

      <div className="mt-8 text-center">
        <button
          onClick={openFortune}
          className="rounded-lg border px-6 py-3 text-lg font-medium hover:bg-gray-100 dark:hover:bg-zinc-800 transition-colors"
        >
          🥠 Open Fortune Cookie
        </button>
      </div>
